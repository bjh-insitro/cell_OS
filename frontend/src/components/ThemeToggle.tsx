...
export const ThemeToggle: React.FC = () => {
    ...
    return (
        <div className="relative flex items-center bg-slate-100 dark:bg-slate-800 rounded-full p-1 border border-slate-200 dark:border-slate-700">
            <button
                type="button"
            ...
            <button
                ...
                className={`p-1.5 rounded-full transition-all ${theme === 'dark'
                    ? 'bg-slate-600 text-indigo-300 shadow-sm'
                    : 'text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                    }`}
                title="Dark Mode"
            >
