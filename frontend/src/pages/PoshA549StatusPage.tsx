    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <WorkflowHeader workflow={mockWorkflow} />

                {!selectedAxis && (
                    <div className="mb-12">
                        <AxisGrid
                            axes={mockWorkflow.axes.filter(a => a.visible !== false)}
                    ...
                    {selectedAxis ? (
                        <div className="animate-fade-in">
                            ...
                            <div className="mb-8">
                                ...
                                <DependencyMap workflow={mockWorkflow} focusedAxisId={selectedAxis.id} />
                            </div>
...
export default PoshA549StatusPage;
