...
Navigate to the **🧬 Cell Line Inspector** tab in the cell_OS dashboard.
...
Click the **🔍 Resolve Protocol** button to generate the protocol.
...
- `media_aliquot`: 40.0 × 0.333 = 13.3 mL
- `pre_warm`: 15.0 × 0.333 = 5.0 mL

When you request T175, volumes are automatically scaled:
- `media_aliquot`: 40.0 × 2.0 = 80.0 mL
- `pre_warm`: 15.0 × 2.0 = 30.0 mL
