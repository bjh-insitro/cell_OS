...
# Test each integration test file individually to find hanging tests
PYTHONPATH=/Users/bjh/cell_OS:$PYTHONPATH
export PYTHONPATH

OUTPUT_FILE="integration_test_results.txt"
TIMEOUT_SECONDS=45

echo "=== Testing Integration Test Files ===" > "$OUTPUT_FILE"
